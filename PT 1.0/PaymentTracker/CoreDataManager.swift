...
struct CoreDataManager {
    ...
    func createFileItem(itemName: String?, itemType: String, checkDate: Date?, checkAmount: String?, lineNumber: String?, linePrice: String?, insCheckCounter: Double?, file: File) -> (FileItem?, Error?) {
        let context = persistentContainer.viewContext
