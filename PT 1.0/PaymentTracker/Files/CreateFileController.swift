...
//            datePicker.date = (file?.founded)!
    ...
    let cocTextField: UITextField = {
        let textField = UITextField()
        textField.placeholder = "Enter coc total"
        // enable autolayout, without this constraints wont load properly
        textField.translatesAutoresizingMaskIntoConstraints = false
    ...
    let invoiceTextField: UITextField = {
        let textField = UITextField()
        textField.placeholder = "Enter invoice total"
        // enable autolayout, without this constraints wont load properly
        textField.translatesAutoresizingMaskIntoConstraints = false
        textField.keyboardType = UIKeyboardType.decimalPad
        return textField
    ...
    let deductibleTextField: UITextField = {
        let textField = UITextField()
        textField.placeholder = "Enter deductible total"
        // enable autolayout, without this constraints wont load properly
        textField.translatesAutoresizingMaskIntoConstraints = false
        textField.keyboardType = UIKeyboardType.decimalPad
        return textField
...
//
    ...
    private func saveFileChanges() {
        ...
        file?.coc = cocTextField.text
        file?.invoice = invoiceTextField.text
        file?.deductible = deductibleTextField.text
