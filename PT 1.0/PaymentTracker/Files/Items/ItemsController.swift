...
//    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let coc = Double(file?.coc ?? ""), let invoice = Double(file?.invoice ?? ""), let deductible = Double(file?.deductible ?? "") {
            ...
            cocTotalLabelInfo.text = "$0.00"
            invoiceTotalLabelInfo.text = "$0.00"
            deductibleTotalLabelInfo.text = "$0.00"
        }
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        if section == 0 {
            ...
            label.text = "Insurance Checks Recieved AND Paid to Viking"
        } else if section == 2 {
            label.text = "Personal Checks Paid to Viking"
        } else if section == 3 {
...
//        overviewLabel.heightAnchor.constraint(equalToConstant: 40).isActive = true
        ...
        cocTotalLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 24).isActive = true
        cocTotalLabel.topAnchor.constraint(equalTo: summaryButton.bottomAnchor).isActive = true
        cocTotalLabel.heightAnchor.constraint(equalToConstant: 40).isActive = true
        
        header.addSubview(cocTotalLabelInfo)
        cocTotalLabelInfo.rightAnchor.constraint(equalTo: header.rightAnchor, constant: -24).isActive = true
        ...
        invoiceTotalLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 24).isActive = true
        invoiceTotalLabel.topAnchor.constraint(equalTo: cocTotalLabel.bottomAnchor).isActive = true
        invoiceTotalLabel.heightAnchor.constraint(equalToConstant: 40).isActive = true
        
        header.addSubview(invoiceTotalLabelInfo)
        invoiceTotalLabelInfo.rightAnchor.constraint(equalTo: header.rightAnchor, constant: -24).isActive = true
        ...
        deductibleTotalLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 24).isActive = true
        deductibleTotalLabel.topAnchor.constraint(equalTo: invoiceTotalLabel.bottomAnchor).isActive = true
        deductibleTotalLabel.heightAnchor.constraint(equalToConstant: 40).isActive = true
        
        header.addSubview(deductibleTotalLabelInfo)
        deductibleTotalLabelInfo.rightAnchor.constraint(equalTo: header.rightAnchor, constant: -24).isActive = true
        ...
        invoiceBalanceTotalLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 24).isActive = true
        invoiceBalanceTotalLabel.topAnchor.constraint(equalTo: deductibleTotalLabel.bottomAnchor).isActive = true
        invoiceBalanceTotalLabel.heightAnchor.constraint(equalToConstant: 40).isActive = true
        
        header.addSubview(invoiceBalanceTotalLabelInfo)
        invoiceBalanceTotalLabelInfo.rightAnchor.constraint(equalTo: header.rightAnchor, constant: -24).isActive = true
