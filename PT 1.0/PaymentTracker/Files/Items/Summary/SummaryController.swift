...
//
    ...
    let insStillOwesHOLabelInfo: UILabel = {
        let label = UILabel()
        label.text = "INSURANCE STILL OWES THIS MUCH"
        label.font = UIFont.boldSystemFont(ofSize: 16)
    ...
    override func viewDidLoad() {
        ...
        if let insCheckACVTotal = Double(file?.insCheckACVTotal ?? ""), let coc = Double(file?.coc ?? ""), let deductible = Double(file?.deductible ?? ""), let insChecksTotal = Double(file?.insCheckTotal ?? ""), let acvItemTotal = Double(file?.acvItemTotal ?? "") {
            ...
            totalLabelInfo.text = amountOwed
            
            let totalInsChecks = currencyFormatter.string(from: NSNumber(value: insChecksTotal))
    ...
    private func setupUI() {
        let header = UIView(frame: CGRect(x: 0, y: 0, width: view.frame.size.width, height: 255))
...
//        insStillOwesHOLabel.widthAnchor.constraint(equalToConstant: 200).isActive = true
        ...
        cocLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 220).isActive = true
        ...
        acvLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 220).isActive = true
        ...
        deductibleLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 174).isActive = true
        ...
        insChecksLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 48).isActive = true
        ...
        line.topAnchor.constraint(equalTo: insChecksLabelInfo.bottomAnchor, constant: 5).isActive = true
        ...
        totalLabel.leftAnchor.constraint(equalTo: headerView.leftAnchor, constant: 220).isActive = true
