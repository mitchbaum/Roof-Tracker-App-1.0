...
//        file?.founded = datePicker.date
        ...
        file?.type = fileTypeSegmentedControl.titleForSegment(at: fileTypeSegmentedControl.selectedSegmentIndex)
        file?.cocSwitch = finalCOCSwitch.isOn
        print("file?.cocSwitch= ", file?.cocSwitch)
...
//        }
    ...
    private func setupUI() {
        ...
        silverBackgroundView.heightAnchor.constraint(equalToConstant: 405).isActive = true
        ...
        finalCOCLabel.topAnchor.constraint(equalTo: deductibleLabel.bottomAnchor).isActive = true
        finalCOCLabel.leftAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leftAnchor, constant: 16).isActive = true
        finalCOCLabel.widthAnchor.constraint(equalToConstant: 150).isActive = true
        //nameLabel.rightAnchor.constraint(equalTo: view.safeAreaLayoutGuide.rightAnchor).isActive = true
        finalCOCLabel.heightAnchor.constraint(equalToConstant: 50).isActive = true
        
        // add final COC switch
        view.addSubview(finalCOCSwitch)
        finalCOCSwitch.leftAnchor.constraint(equalTo: finalCOCLabel.rightAnchor).isActive = true
        finalCOCSwitch.rightAnchor.constraint(equalTo: view.rightAnchor).isActive = true
        finalCOCSwitch.bottomAnchor.constraint(equalTo: finalCOCLabel.bottomAnchor).isActive = true
        finalCOCSwitch.topAnchor.constraint(equalTo: finalCOCLabel.topAnchor, constant: 6).isActive = true
        
        
        
        // add segmented control view
        view.addSubview(fileTypeSegmentedControl)
        fileTypeSegmentedControl.topAnchor.constraint(equalTo: finalCOCLabel.bottomAnchor, constant: 0).isActive = true
