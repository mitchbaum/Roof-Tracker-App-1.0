...
//        }
    ...
    private func setupUI() {
        ...
        silverBackgroundView.heightAnchor.constraint(equalToConstant: 355).isActive = true
        ...
        fileTypeSegmentedControl.topAnchor.constraint(equalTo: deductibleLabel.bottomAnchor, constant: 0).isActive = true
